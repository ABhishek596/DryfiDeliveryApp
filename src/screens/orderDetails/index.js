          ...
          <>
            <View style={styles.order_box}>
              <View style={[styles.order_row, {alignItems: 'center'}]}>
                <Text style={[styles.head, {width: SIZES.width * 0.3}]}>
                  Items Summery
                </Text>
                <Text style={[styles.head, {width: SIZES.width * 0.3}]}>
                  Order
                </Text>
                <Text style={[styles.head, {width: SIZES.width * 0.12}]}>
                  Qty
                </Text>
              </View>
              {item?.Item_Details?.map((item, index) => (
                <View key={index} style={styles.order_row}>
                  <Text style={[styles.row_title, {width: SIZES.width * 0.3}]}>
                    {item.product_name}
                  </Text>
                  <Text style={[styles.row_text, {width: SIZES.width * 0.3}]}>
                    {item.service_name}
                  </Text>
                  <Text style={[styles.row_text, {width: SIZES.width * 0.12}]}>
                    {item.qty}
                  </Text>
                </View>
              ))}
        ...
        <View>
          <View style={styles.row}>
            <Text style={styles.order_id}>
              {item?.Payment_Mode_Details?.payment_mode}
            </Text>
