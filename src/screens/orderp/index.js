import {
  ...
  const Orderp = ({
    ...
    const [setActiveFunctionc, setSetActiveFunctionc] = useState(route.params?.setActiveFunctionc);
    const [setActiveFunction, setSetActiveFunction] = useState(route.params?.setActiveFunction);
    const [setActiveFunctionb, setSetActiveFunctionb] = useState(route.params?.setActiveFunctionb);
    ...
    useEffect(() => {
      ...
      if (setActiveFunction) {
        ...
        handleTabChange(setActiveFunction);
      }
    }, []);
  ...
  export default connect(mapStateToProps, mapDispatchToProps)(memo(Orderp));
